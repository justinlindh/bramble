...
| Seeed SenseCAP T1000-E (card tracker) | nRF52840 | None (BLE-only interface) | Button | LR1110 | Buzzer | Experimental: boots, BLE RPC, joins the mesh; GNSS driver implemented for the onboard AG3335 module but not yet bench-verified; power management not yet implemented ([nrf/](nrf/)) |
