...
// (150 units, see radio_derive_range in sim_radio.c), I hears all three
// spokes but no spoke hears another (E-D is 280 units, F-D and E-F are
// both ~198, all out of range). "collisions":false keeps this
