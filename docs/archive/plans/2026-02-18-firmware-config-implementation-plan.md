...
## Phase 1: Radio Settings (setRadio) ✅ COMPLETE
*Estimate: 1 hour*
...
### Task 1.4: Add radio profile presets ✅ (profiles exist in radio_esp.c but setRadio always reports "custom")
...
## Phase 2: Channel Management ✅ COMPLETE
*Estimate: 1.5 hours*
...
## Phase 3: Network Probe (sendProbe) ✅ COMPLETE
*Estimate: 45 minutes*
...
### Task 3.3: Wire probe results to getStatus or new RPC ✅ (onProbeResult notification working)
...
### Task 5.2: Implement location contacts ✅ (NVS set/remove)
...
### Task 5.3: Implement getPeerLocations ✅ (returns own location from NVS)
