...
static inline int wifi_manager_init(uint32_t node_addr) { (void)node_addr; return 0; }
...
static inline int wifi_manager_nvs_get_creds(char *ssid, size_t ssid_len, char *password, size_t pass_len) {
    (void)ssid; (void)ssid_len; (void)password; (void)pass_len; return -1;
}
