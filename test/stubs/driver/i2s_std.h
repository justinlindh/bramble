...
typedef struct {
    struct { int sample_rate; } clk_cfg;
...
#define I2S_CHANNEL_DEFAULT_CONFIG(_id, _role) ((i2s_chan_config_t){ .id=(_id), .role=(_role), .auto_clear=false })
#define I2S_STD_CLK_DEFAULT_CONFIG(_rate) ((typeof(((i2s_std_config_t*)0)->clk_cfg)){ .sample_rate=(_rate) })
#define I2S_STD_PHILIPS_SLOT_DEFAULT_CONFIG(_width, _mode) ((typeof(((i2s_std_config_t*)0)->slot_cfg)){ .data_bit_width=(_width), .slot_mode=(_mode) })
