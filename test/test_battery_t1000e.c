...
/* Averaging is deliberately absent here: the driver uses the fleet-shared
 * battery_average_mv (components/battery/battery_helpers.c), whose
 * valid-mask behavior test_battery.c already covers. */
