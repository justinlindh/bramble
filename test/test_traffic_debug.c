...
void test_classify_beacon(void) {
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_BEACON, traffic_debug_classify_packet(PKT_TYPE_BEACON));
}

void test_classify_routing_packets(void) {
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_ROUTING, traffic_debug_classify_packet(PKT_TYPE_RREQ));
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_ROUTING, traffic_debug_classify_packet(PKT_TYPE_RREP));
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_ROUTING, traffic_debug_classify_packet(PKT_TYPE_RERR));
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_ROUTING, traffic_debug_classify_packet(PKT_TYPE_PROBE));
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_ROUTING, traffic_debug_classify_packet(PKT_TYPE_PROBE_ACK));
}

void test_classify_ack_packets(void) {
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_ACK, traffic_debug_classify_packet(PKT_TYPE_ACK));
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_ACK, traffic_debug_classify_packet(PKT_TYPE_DELIVERY_RECEIPT));
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_ACK, traffic_debug_classify_packet(PKT_TYPE_STORE_ACK));
}

void test_classify_chat_packets(void) {
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_CHAT, traffic_debug_classify_packet(PKT_TYPE_DATA));
}
...
void test_classify_other_packets(void) {
    /* Unknown packet type */
    TEST_ASSERT_EQUAL(TRAFFIC_CAT_OTHER, traffic_debug_classify_packet(0xFF));
}
