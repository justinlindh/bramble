...
static const bramble_board_config_t board_tdeck_plus = {
    ...
    .capabilities = BOARD_CAP_DISPLAY_ST7789 | BOARD_CAP_KEYBOARD | BOARD_CAP_TRACKBALL |
                    BOARD_CAP_GPS | BOARD_CAP_SDCARD | BOARD_CAP_AUDIO | BOARD_CAP_BATTERY_ADC |
                    BOARD_CAP_SHARED_SPI | BOARD_CAP_PERIPHERAL_POWER | BOARD_CAP_TOUCH,
