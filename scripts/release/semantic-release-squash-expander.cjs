...
//
//   pathScopes: { 'webapp/': 'webapp', 'main/': 'firmware' }
//
// Bramble's four release configs (.releaserc.{firmware,webapp,protocol,sim}.cjs)
// keep pathScopes unset so releases stay strictly scope-gated.
