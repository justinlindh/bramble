...
bash scripts/traffic-capture.sh 192.0.2.0

# Custom duration (in seconds) and output file
bash scripts/traffic-capture.sh 192.0.2.0 600 my-capture.jsonl
...
- **Live Device Capture:** Requires firmware Tasks 1-4 to be deployed on device
  - Device at 192.0.2.0 does not yet have traffic debug methods
