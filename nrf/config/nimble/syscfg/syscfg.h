/*
 * NimBLE syscfg for the Bramble nRF52840 target.
 *
 * Generated upstream for the RIOT port (the FreeRTOS port ships a host-only
 * syscfg with no controller values) and tuned here: peripheral role only,
...
#define MYNEWT_VAL_BLE_LL_SCA (250)
#endif
